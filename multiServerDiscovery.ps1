...
param(
  ...
  [string] $OutputRoot = ".",
  [string] $Username = "",
  [string] $Password = ""   # plain text (for pipeline secret). If interactive, leave blank and you will be prompted.
)
...
# Build credential (pipeline-friendly)
$cred = $null
...
# ---------- Excel COM writer (offline, no modules) ----------
